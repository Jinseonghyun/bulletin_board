...
public class UserNotificationHistoryService {
    ...
    public UserNotificationHistoryService(UserNotificationHistoryRepository userNotificationHistoryRepository, NoticeRepository noticeRepository, UserRepository userRepository) {
    ...
    public List<UserNotificationHistory> getNotificationList() {
        ...
        LocalDateTime weekDate = LocalDateTime.now().minusDays(7);
        // 일주일 전 알림만 노출
